...
################################################################################
## Form generated from reading UI file 'mainwindow2KSUsuk.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(270, 183)
        icon = QIcon()
        icon.addFile(u":/iconos/curso/extractor_ocr.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
...
"}")
        ...
        icon1 = QIcon()
        icon1.addFile(u":/iconos/curso/x_icon.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.menubar.setGeometry(QRect(0, 0, 270, 33))
